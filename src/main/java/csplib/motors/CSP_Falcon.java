...
public class CSP_Falcon extends WPI_TalonFX implements CSP_Motor {
    ...
    public double getPosition() {
        return (super.getSelectedSensorPosition() / Constants.Robot.FALCON_CPM) * posScalar;
    }

    public double getVelocity() {
        return ((super.getSelectedSensorVelocity() / Constants.Robot.FALCON_CPM * 10) * 60) * velScalar;
    }
