...
>>>>>>> ebaf4ef77babfdbacd2d0472837bc920803ecc2b
            ...
            public static final PIDController xPID = new PIDController(XkP, XkI, XkD);
        
            public static final double YkP = 5.2;
            public static final double YkI = 0.0;
            public static final double YkD = 0.0;  
            public static final PIDController yPID = new PIDController(YkP, YkI, YkD);

            public static final double THETA_kP = -17.25;
            public static final double THETA_kI = 0.0;
            public static final double THETA_kD = -0.05;  
            public static final ProfiledPIDController thetaPID = new ProfiledPIDController(THETA_kP, THETA_kI, THETA_kD, new Constraints(Math.PI * 2.0, Math.PI / 2.0));

            public static final double AUTO_MAX_VELOCITY = 1.0; // Maximum velocity allowed in the drivetrain (Meters per Second).
            public static final double AUTO_MAX_ACCEL = 3.0; // Maximum acceleration of the drivetrain in (Meters per Second Squared).
            public static final double AUTO_MAX_CACCEL = 5.0; // Maximum centripital acceleration of the robot (Meters per Second Squared).
        }
