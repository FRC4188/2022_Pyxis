...
public class ModuleConstants {
    ...
    public Vector<N2> ANGLE_STATE_STDEV = VecBuilder.fill(3.6e4, 3.6e3);
    /** Standard deviaiton in the encoder measurements for the module angle. */
    public Vector<N1> ANGLE_ENC_STDEV = VecBuilder.fill(3.6e-5);

    /** Qelm constant; measurement error tolerance. */
    public Vector<N2> ANGLE_QELMS = VecBuilder.fill(270.0, 360.0);
    /** Relm constant; control effort tolerance. */
    public Vector<N1> ANGLE_RELMS = VecBuilder.fill(0.125);
    ...
    public double SPEED_STATE_STDEV = 5e4;
    /** Standard deviaiton in the encoder measurements for the module speed. */
    public double SPEED_ENC_STDEV = 1e-5;

    /** Qelm constant; measurement error tolerance. */
    public double SPEED_QELMS = 2.0;
    /** Relm constant; control effort tolerance. */
    public double SPEED_RELMS = 0.15;
    ...
    static {
        ...
        modules[0].ENC_ID = 21;
        modules[0].ZERO = 0.0;
        modules[0].ANGLE_kV = 1.1059E-49;
        modules[0].ANGLE_kA = 5.1324E-51;

        modules[1].ANGLE_ID = 3;
        modules[1].SPEED_ID = 4;
        modules[1].ENC_ID = 22;
        modules[1].ZERO = 0.0;
        modules[1].ANGLE_kV = 1.1059E-49;
        modules[1].ANGLE_kA = 5.1324E-51;

        modules[2].ANGLE_ID = 5;
        modules[2].SPEED_ID = 6;
        modules[2].ENC_ID = 23;
        modules[2].ZERO = 0.0;
        modules[2].ANGLE_kV = 1.1059E-49;
        modules[2].ANGLE_kA = 5.1324E-51;

        modules[3].ANGLE_ID = 7;
        modules[3].SPEED_ID = 8;
        modules[3].ENC_ID = 24;
        modules[3].ZERO = 0.0;
        modules[3].ANGLE_kV = 1.1059E-49;
        modules[3].ANGLE_kA = 5.1324E-51;
    }
}
