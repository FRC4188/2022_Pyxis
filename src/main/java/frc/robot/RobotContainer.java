...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    pilot.getDpadUpButtonObj().whenPressed(new ActivePosition(Constants.climber.MAX_HEIGHT + 0.03));

    pilot
        .getDpadDownButtonObj()
        .whenPressed(new ActivePosition(0.0))
        .whenActive(new RunCommand(() -> shooter.setVelocity(0), shooter));

    pilot.getStartButtonObj().whenPressed(new MonkeyBar());
    ...
    pilot.getDpadLeftButtonObj().whenPressed(new SetToAngle(0.0));
    ...
    copilot.getDpadUpButtonObj().whenPressed(new SetToAngle(0.0));

    copilot.getDpadLeftButtonObj().whenPressed(new SetToAngle(-90.0));

    copilot.getDpadDownButtonObj().whenPressed(new SetToAngle(-180.0));

    copilot.getDpadRightButtonObj().whenPressed(new SetToAngle(-270.0));

    copilot.getLbButtonObj().whenPressed(new TogglePassive());
