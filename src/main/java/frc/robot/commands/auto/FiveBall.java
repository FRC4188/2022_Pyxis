    ...
    addCommands(
        ...
        new ParallelDeadlineGroup(
            new FollowTrajectory(
                Trajectories.twoball.toFirst.relativeTo(
        ...
        new ParallelDeadlineGroup(
            new SequentialCommandGroup(
                new FollowTrajectory(
                    Trajectories.fiveball.terminal1.relativeTo(
                        new Pose2d(0, 0, Rotation2d.fromDegrees(90.0))),
                    Rotation2d.fromDegrees(-140.0)),
                new FollowTrajectory(
                    Trajectories.fiveball.terminal2.relativeTo(
                        new Pose2d(0, 0, Rotation2d.fromDegrees(90.0))),
                    Rotation2d.fromDegrees(-140.0)),
                new FollowTrajectory(
                    Trajectories.fiveball.shoot2.relativeTo(
                        new Pose2d(0, 0, Rotation2d.fromDegrees(90.0))),
                    Rotation2d.fromDegrees(54.18 - 90.0))),
