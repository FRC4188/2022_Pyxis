...
public class Limelight extends SubsystemBase {
    ...
    public double formulaRpm() {        
        ...
        if (getDistance() > 7.5 && getDistance() < 20.6) {
            setRPM = 410.347 * Math.sin(0.245553 * getDistance() + 2.27388) + 3507.96;
        } else if (getDistance() > 22 && getDistance() < 24) {
            setRPM = 3500; //for fun (climbed shot)
        } else if (getDistance() < 8.2) {
            setRPM = 2000;
        } else {
            setRPM = 5600;
        }
