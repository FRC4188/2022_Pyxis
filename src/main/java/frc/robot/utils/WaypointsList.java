    ...
    public static final class MTrenchSixBall {
        ...
        public static final Waypoints DOWN_TRENCH = new Waypoints(
            List.of(
                ...
                new Pose2d(2.0, 1.55, new Rotation2d()),
                new Pose2d(2.98, 1.55, new Rotation2d()),
                new Pose2d(4.3, 1.58, new Rotation2d())
            ), false);

        public static final Waypoints TO_SHOOT = new Waypoints(
            List.of(
                new Pose2d(4.3, 1.55, new Rotation2d()),
                INITIAL_POSE
            ), true);
    }
    ...
    public static final class WheelFiveBall {
        ...
        public static final Waypoints FIRST_PATH = new Waypoints(
            List.of(
                ...
                new Pose2d(2.6, -0.55, Rotation2d.fromDegrees(-33))
            ), false);
        ...
        public static final Waypoints THIRD_PATH = new Waypoints(
            List.of(
                new Pose2d(1.56, 0, Rotation2d.fromDegrees(-20)),
                new Pose2d(2.55, 0.5, Rotation2d.fromDegrees(-44.5))
            ), false);
        
        public static final Waypoints FOURTH_PATH = new Waypoints(
            List.of(
                new Pose2d(2.55, -0.68, Rotation2d.fromDegrees(-44.5)),
